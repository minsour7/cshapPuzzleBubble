...
namespace Google.Protobuf.Protocol {
    ...
    static StructReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ASgFEiUKB1BsYXllcnMYAiABKAsyFC5Qcm90b2NvbC5QbGF5ZXJJbmZvIjsK",
            "C0NvbHNCdWJibGVzEiwKC0J1YmJsZVR5cGVzGAEgASgOMhcuUHJvdG9jb2wu",
            "RV9CVUJCTEVfVFlQRSJCCgpQbGF5ZXJSYW5rEhAKCFBsYXllcklkGAEgASgF",
            "EgwKBFJhbmsYAiABKAUSFAoMRGlzQ29ubmVjdGVkGAMgASgIQhuqAhhHb29n",
  ...
  public sealed partial class ColsBubbles : pb::IMessage<ColsBubbles> {
    ...
    private global::Google.Protobuf.Protocol.E_BUBBLE_TYPE bubbleTypes_ = global::Google.Protobuf.Protocol.E_BUBBLE_TYPE.BubbleNone;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Google.Protobuf.Protocol.E_BUBBLE_TYPE BubbleTypes {
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (BubbleTypes != global::Google.Protobuf.Protocol.E_BUBBLE_TYPE.BubbleNone) hash ^= BubbleTypes.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void WriteTo(pb::CodedOutputStream output) {
      if (BubbleTypes != global::Google.Protobuf.Protocol.E_BUBBLE_TYPE.BubbleNone) {
        output.WriteRawTag(8);
        output.WriteEnum((int) BubbleTypes);
      }
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    ...
    public int CalculateSize() {
      int size = 0;
      if (BubbleTypes != global::Google.Protobuf.Protocol.E_BUBBLE_TYPE.BubbleNone) {
        size += 1 + pb::CodedOutputStream.ComputeEnumSize((int) BubbleTypes);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
    ...
    public void MergeFrom(ColsBubbles other) {
      ...
      if (other.BubbleTypes != global::Google.Protobuf.Protocol.E_BUBBLE_TYPE.BubbleNone) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 8: {
            BubbleTypes = (global::Google.Protobuf.Protocol.E_BUBBLE_TYPE) input.ReadEnum();
            break;
          }
        }
      }
