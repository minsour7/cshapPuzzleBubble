...
namespace Google.Protobuf.Protocol {
    ...
    static ProtocolReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "dC5wcm90byIxCglTX0Nvbm5lY3QSJAoGUGxheWVyGAEgASgLMhQuUHJvdG9j",
            "b2wuUGxheWVySW5mbyIcCgpDX1Jvb21JbmZvEg4KBlJvb21JZBgBIAEoBSIy",
            "CgpTX1Jvb21JbmZvEiQKCFJvb21JbmZvGAEgASgLMhIuUHJvdG9jb2wuUm9v",
            "bUluZm8iNgoOQ19Kb2luR2FtZVJvb20SJAoGUGxheWVyGAEgASgLMhQuUHJv",
            "dG9jb2wuUGxheWVySW5mbyI2Cg5TX0pvaW5HYW1lUm9vbRIkCghSb29tSW5m",
            "bxgBIAEoCzISLlByb3RvY29sLlJvb21JbmZvIhEKD1NfTGVhdmVHYW1lUm9v",
            "bSJACgdTX1NwYXduEg4KBlJvb21JZBgBIAEoBRIlCgdQbGF5ZXJzGAIgASgL",
            "MhQuUHJvdG9jb2wuUGxheWVySW5mbyJDCglTX0Rlc3Bhd24SEAoIUm9vbUlu",
            "Zm8YASABKAUSJAoGUGxheWVyGAIgASgLMhQuUHJvdG9jb2wuUGxheWVySW5m",
            "byJDCgtDX1N0YXJ0R2FtZRIkCghSb29tSW5mbxgBIAEoCzISLlByb3RvY29s",
            "LlJvb21JbmZvEg4KBlJvb21JZBgCIAEoBSIdCgtTX1N0YXJ0R2FtZRIOCgZS",
            "b29tSWQYASABKAUiHgoHQ19TaG9vdBITCgtSYWRpYW5BbmdsZRgBIAEoBSIw",
            "CgdTX1Nob290EhAKCFBsYXllcklkGAEgASgFEhMKC1JhZGlhbkFuZ2xlGAIg",
            "ASgFIiQKBkNfTW92ZRIMCgRQb3NYGAEgASgFEgwKBFBvc1kYAiABKAUiNgoG",
            "U19Nb3ZlEhAKCFBsYXllcklkGAEgASgFEgwKBFBvc1gYAiABKAUSDAoEUG9z",
            "WRgDIAEoBSIhCg1DX05leHRCdWJibGVzEhAKCFJlcUNvdW50GAEgASgFIjsK",
            "DVNfTmV4dEJ1YmJsZXMSKgoLQnViYmxlVHlwZXMYASABKAsyFS5Qcm90b2Nv",
            "bC5Db2xzQnViYmxlcyI6ChFTX05leHRCdWJibGVzUGVlchIQCghQbGF5ZXJJ",
            "ZBgBIAEoBRITCgtCdWJibGVUeXBlcxgCIAEoBSISChBDX05leHRDb2xzQnVi",
            "YmxlIicKEFNfTmV4dENvbHNCdWJibGUSEwoLQnViYmxlVHlwZXMYASABKAUi",
            "PQoUU19OZXh0Q29sc0J1YmJsZVBlZXISEAoIUGxheWVySWQYASABKAUSEwoL",
            "QnViYmxlVHlwZXMYAiABKAUiKQoUQ19OZXh0Q29sc0J1YmJsZUxpc3QSEQoJ",
            "Q29sc0NvdW50GAEgASgFIkIKFFNfTmV4dENvbHNCdWJibGVMaXN0EioKC0Nv",
            "bHNCdWJibGVzGAEgASgLMhUuUHJvdG9jb2wuQ29sc0J1YmJsZXMiNwoRQ19G",
            "aXhlZEJ1YmJsZVNsb3QSEgoKQ29sc1Nsb3RJZBgBIAEoBRIOCgZTbG90SWQY",
            "AiABKAUiTQoVU19GaXhlZEJ1YmJsZVNsb3RQZWVyEhAKCFBsYXllcklkGAEg",
            "ASgFEhIKCkNvbHNTbG90SWQYAiABKAUSDgoGU2xvdElkGAMgASgFIhIKEENf",
            "UGxheWVyR2FtZU92ZXIiRQoZU19QbGF5ZXJHYW1lT3ZlckJyb2FkQ2FzdBIo",
            "CgpQbGF5ZXJSYW5rGAEgASgLMhQuUHJvdG9jb2wuUGxheWVyUmFuayI5CgxT",
            "X0dhbWVSZXN1bHQSKQoLUGxheWVyUmFua3MYASABKAsyFC5Qcm90b2NvbC5Q",
            "bGF5ZXJSYW5rQhuqAhhHb29nbGUuUHJvdG9idWYuUHJvdG9jb2xQAFABYgZw",
            "cm90bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::Google.Protobuf.Protocol.S_Despawn), global::Google.Protobuf.Protocol.S_Despawn.Parser, new[]{ "RoomInfo", "Player" }, null, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::Google.Protobuf.Protocol.C_StartGame), global::Google.Protobuf.Protocol.C_StartGame.Parser, new[]{ "RoomInfo", "RoomId" }, null, null, null, null),
  ...
  public sealed partial class S_Despawn : pb::IMessage<S_Despawn> {
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (RoomInfo != 0) hash ^= RoomInfo.GetHashCode();
      if (player_ != null) hash ^= Player.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
    ...
    public int CalculateSize() {
      int size = 0;
      if (RoomInfo != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(RoomInfo);
      }
      if (player_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(Player);
      }
  ...
  public sealed partial class C_Shoot : pb::IMessage<C_Shoot> {
    ...
    private int radianAngle_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public int RadianAngle {
    ...
    public bool Equals(C_Shoot other) {
      ...
      if (RadianAngle != other.RadianAngle) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (RadianAngle != 0) hash ^= RadianAngle.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    public int CalculateSize() {
      int size = 0;
      if (RadianAngle != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(RadianAngle);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
  ...
  public sealed partial class S_NextBubbles : pb::IMessage<S_NextBubbles> {
    ...
    public S_NextBubbles(S_NextBubbles other) : this() {
      bubbleTypes_ = other.bubbleTypes_ != null ? other.bubbleTypes_.Clone() : null;
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    private global::Google.Protobuf.Protocol.ColsBubbles bubbleTypes_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Google.Protobuf.Protocol.ColsBubbles BubbleTypes {
    ...
    public bool Equals(S_NextBubbles other) {
      ...
      if (!object.Equals(BubbleTypes, other.BubbleTypes)) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (bubbleTypes_ != null) hash ^= BubbleTypes.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void WriteTo(pb::CodedOutputStream output) {
      if (bubbleTypes_ != null) {
        output.WriteRawTag(10);
        output.WriteMessage(BubbleTypes);
      }
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    ...
    public int CalculateSize() {
      int size = 0;
      if (bubbleTypes_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(BubbleTypes);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
    ...
    public void MergeFrom(S_NextBubbles other) {
      ...
      if (other.bubbleTypes_ != null) {
        if (bubbleTypes_ == null) {
          BubbleTypes = new global::Google.Protobuf.Protocol.ColsBubbles();
        }
        BubbleTypes.MergeFrom(other.BubbleTypes);
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
  ...
  public sealed partial class S_NextBubblesPeer : pb::IMessage<S_NextBubblesPeer> {
    ...
    public S_NextBubblesPeer(S_NextBubblesPeer other) : this() {
      playerId_ = other.playerId_;
      bubbleTypes_ = other.bubbleTypes_;
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    public bool Equals(S_NextBubblesPeer other) {
      ...
      if (PlayerId != other.PlayerId) return false;
      if (BubbleTypes != other.BubbleTypes) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (PlayerId != 0) hash ^= PlayerId.GetHashCode();
      if (BubbleTypes != 0) hash ^= BubbleTypes.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    public int CalculateSize() {
      ...
      if (BubbleTypes != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(BubbleTypes);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
    ...
    public void MergeFrom(S_NextBubblesPeer other) {
      ...
      if (other.BubbleTypes != 0) {
        BubbleTypes = other.BubbleTypes;
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
  ...
  public sealed partial class S_NextColsBubbleList : pb::IMessage<S_NextColsBubbleList> {
    ...
    public S_NextColsBubbleList(S_NextColsBubbleList other) : this() {
      colsBubbles_ = other.colsBubbles_ != null ? other.colsBubbles_.Clone() : null;
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    private global::Google.Protobuf.Protocol.ColsBubbles colsBubbles_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Google.Protobuf.Protocol.ColsBubbles ColsBubbles {
    ...
    public bool Equals(S_NextColsBubbleList other) {
      ...
      if (!object.Equals(ColsBubbles, other.ColsBubbles)) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (colsBubbles_ != null) hash ^= ColsBubbles.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void WriteTo(pb::CodedOutputStream output) {
      if (colsBubbles_ != null) {
        output.WriteRawTag(10);
        output.WriteMessage(ColsBubbles);
      }
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    ...
    public int CalculateSize() {
      int size = 0;
      if (colsBubbles_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(ColsBubbles);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
    ...
    public void MergeFrom(S_NextColsBubbleList other) {
      ...
      if (other.colsBubbles_ != null) {
        if (colsBubbles_ == null) {
          ColsBubbles = new global::Google.Protobuf.Protocol.ColsBubbles();
        }
        ColsBubbles.MergeFrom(other.ColsBubbles);
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
  ...
  public sealed partial class S_GameResult : pb::IMessage<S_GameResult> {
    ...
    public S_GameResult(S_GameResult other) : this() {
      playerRanks_ = other.playerRanks_ != null ? other.playerRanks_.Clone() : null;
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    private global::Google.Protobuf.Protocol.PlayerRank playerRanks_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Google.Protobuf.Protocol.PlayerRank PlayerRanks {
    ...
    public bool Equals(S_GameResult other) {
      ...
      if (!object.Equals(PlayerRanks, other.PlayerRanks)) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (playerRanks_ != null) hash ^= PlayerRanks.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void WriteTo(pb::CodedOutputStream output) {
      if (playerRanks_ != null) {
        output.WriteRawTag(10);
        output.WriteMessage(PlayerRanks);
      }
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    ...
    public int CalculateSize() {
      int size = 0;
      if (playerRanks_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(PlayerRanks);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
    ...
    public void MergeFrom(S_GameResult other) {
      ...
      if (other.playerRanks_ != null) {
        if (playerRanks_ == null) {
          PlayerRanks = new global::Google.Protobuf.Protocol.PlayerRank();
        }
        PlayerRanks.MergeFrom(other.PlayerRanks);
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
